...
namespace RoguelikeGeneratorPro
{
    public class RoguelikeGeneratorPro : MonoBehaviour
    {
        ...
        private void CreateTilesParents()
        {
            ...
            floorParent.AddComponent<NavMeshModifier>();
            floorParent.GetComponent<NavMeshModifier>().overrideArea = true;
            floorParent.GetComponent<NavMeshModifier>().area = 3;
            ...
            wallParent.AddComponent<NavMeshModifier>();
            wallParent.GetComponent<NavMeshModifier>().overrideArea = true;
            wallParent.GetComponent<NavMeshModifier>().area = 4;
