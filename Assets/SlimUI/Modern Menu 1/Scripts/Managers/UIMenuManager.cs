...
namespace SlimUI.ModernMenu{
	public class UIMenuManager : MonoBehaviour {
		...
		public TransitionSettings _transition;
        ...
        public void TransitionToCampaign()
        {
			TransitionManager.Instance().Transition("Campaign1", _transition, 0.2f);
        ...
        public void LeaderboardBegin()
        {
            DisablePlayCampaign();
            CameraObject.SetFloat("Leaderboard", 1);
        }

        public void LeaderboardEnd()
        {
            CameraObject.SetFloat("Leaderboard", 0);
        }
        void DisablePanels(){
