...
public class Softbody : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        jv = new VertexBody[MeshClone.vertices.Length];
        for (int i = 0; i < MeshClone.vertices.Length; i++)
            jv[i] = new VertexBody(i, transform.TransformPoint(MeshClone.vertices[i]));
    ...
    public class VertexBody
    {
        ...
        public VertexBody(int _id, Vector3 _pos)
        {
            ID = _id;
            Position = _pos;
        }
