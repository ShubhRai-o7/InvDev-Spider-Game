...
public class ShooterLeg : MonoBehaviour
{
    // Self-explanatory variable names
    private ShooterLegController legController;
    ...
    private float tipMoveDist = 1.65f;
    private float maxRayDist = 21.0f;
    private float tipPassOver = 1.65f / 6.0f;
    ...
    private void Awake()
    {
        legController = GetComponentInParent<ShooterLegController>();
